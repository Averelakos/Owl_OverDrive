...
{
    /// <inheritdoc />
    public partial class AddTableGameLocalization : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GameLocalizations_Users_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GameLocalizations_Users_LastUpdatedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameLocalizations_CreatedById",
                table: "GameLocalizations",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_GameLocalizations_LastUpdatedById",
                table: "GameLocalizations",
