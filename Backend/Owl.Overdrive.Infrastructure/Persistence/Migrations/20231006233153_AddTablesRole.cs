...
{
    /// <inheritdoc />
    public partial class AddTablesRole : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { -1L, null, "System Role", null, "System" },
                    { 1L, null, "Administrator Role", null, "Administrator" },
                    { 2L, null, "Agent Role", null, "Agent" },
                    { 3L, null, "Reviewer Role", null, "Reviewer" },
                    { 4L, null, "Default Role", null, "Defauls" }
                });
